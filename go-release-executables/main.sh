...
md5sum ${GITHUB_REPOSITORY}/${SUBDIR}/${EXECUTABLE_FILES} | cut -d ' ' -f 1 > ${CKSUM_FILE}
tar cvfz ${TMP_ARCHIVE} ${CKSUM_FILE} --directory ${GITHUB_REPOSITORY}/${SUBDIR} ${EXECUTABLE_FILES}
